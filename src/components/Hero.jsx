      ...
      <div className="flex flex-col-reverse md:flex-row items-center gap-10 md:gap-16">
        ...
        >
          ...
          <motion.h2
            ...
            className="text-xl sm:text-2xl text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-purple-600 to-pink-500 font-medium tracking-tight"
          >
        ...
        >
          <div className="relative w-56 h-56 sm:w-64 sm:h-64 md:w-72 md:h-72">
            <div className="absolute inset-0 rounded-full bg-gradient-to-br from-blue-400/30 via-purple-400/20 to-pink-500/15 blur-3xl" />
            <div className="relative w-full h-full rounded-full overflow-hidden border-4 border-blue-500/20 shadow-2xl shadow-blue-500/10">
              <img
